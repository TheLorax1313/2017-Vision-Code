...
public class Main {
	...
	MjpegServer inputStream2 = new MjpegServer("MJPEG Server", streamPort3);
   	UsbCamera camera0 = new UsbCamera("CoprocessorCamera", 0);
    	inputStream0.setSource(camera0);
    	camera0.setResolution(270,350);

	UsbCamera camera1 = new UsbCamera("CoprocessorCamera", 1);
    	inputStream1.setSource(camera1);
    	camera1.setResolution(360,240);

	UsbCamera cameraVision = new UsbCamera("CoprocessorCamera", 2);
    	inputStream2.setSource(cameraVision);
    	cameraVision.setResolution(370,240);
	
	CvSink imageSink = new CvSink("CV Image Grabber");
	imageSink.setSource(camera0);
	
	CvSource imageSource = new CvSource("CV Image Source", VideoMode.PixelFormat.kMJPEG, 360, 240, 30);
	...
	/*
		...
		//Placing Width
		Pi_RioCom.putNumber("Width0",rectWidth0);
		Pi_RioCom.putNumber("Width1",rectWidth1);
		Pi_RioCom.putNumber("Width2",rectWidth2);
		Pi_RioCom.putNumber("Width3",rectWidth3);
		
		//Placing Height
		Pi_RioCom.putNumber("Height0",rectHeight0);
		Pi_RioCom.putNumber("Height1",rectHeight1);
		Pi_RioCom.putNumber("Height2",rectHeight2);
		Pi_RioCom.putNumber("Height3",rectHeight3);
